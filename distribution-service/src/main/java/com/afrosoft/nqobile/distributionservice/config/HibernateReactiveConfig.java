package com.afrosoft.nqobile.distributionservice.config;
...
public class HibernateReactiveConfig {
    ...
    public Stage.SessionFactory sessionFactory() {
        ...
        metadataSources.addAnnotatedClass(com.afrosoft.nqobile.distributionservice.model.DistributionCycle.class);
