package com.afrosoft.nqobile.subscriptionsandpayments.config;
...
public class HibernateReactiveConfig {
    ...
    public Stage.SessionFactory sessionFactory() {
        ...
        metadataSources.addAnnotatedClass(com.afrosoft.nqobile.subscriptionsandpayments.model.SubscriptionOrder.class);
